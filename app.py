...
data = pd.read_excel('/Users/abhisreeravela/Downloads/CNN/dataset/clusterAnalysis/WDMDataset.xlsx')
...
# If using 'ward' linkage, 'affinity' must be 'euclidean'
...
# prompt: create knn model similar to the above models and also add accuracy
